...
\node (SI) [right=of S]{{}};
\node (I2) [right=of SI,bigcompartment,bottom color=red!30]{{$I_{gen}$}};
\node (I12) [above=of I2]{};
\node (I23) [below=of I2]{};
\node (I1) [bigcompartment,bottom color=red!30,above=of I12] {{$I_{anus}$}};
\node (I3) [bigcompartment,bottom color=red!30,below=of I23] {{$I_{oro}$}};
\node (IR) [right=of I2]{};
\node (R) [right=of IR,bigcompartment,bottom color=yellow!30]{$R+$};
...
\draw[very thick, ->] (I1) to node[above,xshift=3ex]{seropos.} (R);
\draw[very thick, ->] (I2) to node[above]{seropos.}(R);
\draw[very thick, ->] (I3) to node[above,xshift=-3ex]{seropos.}(R);

%\draw[very thick,->] (R) to[bend left=85] (S);
\draw[very thick,->] (R) .. controls +(-3.5,-9) and +(3.5,-9) .. node{sero-reversion}(S);
